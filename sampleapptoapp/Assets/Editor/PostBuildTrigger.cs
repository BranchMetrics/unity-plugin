...
public static class PostBuildTrigger
{
	...
	const string FRAMEWORK_ID_ADSUPPORT = "4266CDCF18907E7500C4E70B";
	const string FRAMEWORK_FILEREFID_ADSUPPORT = "4266CDCE18907E7500C4E70B";
	...
	public static void updateXcodeProject(string xcodeprojPath, Dictionary<string, framework> dictFrameworks)
	{
        ...
        while (!bFound && !bEnd)
        {
			...
			bFound = existsADSUPPORT && existsCORETELEPHONY && existsIAD && existsMOBILECORESERVICES && existsSYSTEMCONFIGURATION;
